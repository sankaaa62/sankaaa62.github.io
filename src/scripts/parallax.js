...
if (layers.length) {
  ...
  // целевые позиции сошлись (лерп практически завершен), останавливаем rAF и
  ...
  function tick() {
    ...
    if (!document.hidden) {
      ...
      allConverged = false; // страница скрыта — не гоняем rAF, но и не считаем это сходимостью; просто ждем следующего кадра видимости
    }
